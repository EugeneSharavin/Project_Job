...
Процедура _ДемоРеализацияТоваровПроверкаПроведенияСОшибкамиНедопустимыйСтатус() Экспорт
	...
	ЮТест.ОжидаетЧто(Сообщения)
		...
		.Свойство("[1].Текст")
			.Содержит(НСтр("ru = 'В строке 1 истек срок действия подарочного сертификата!'"))
		.Свойство("[2].Текст")
			.Содержит(НСтр("ru = 'В строке 1 номинальная стоимость подарочного сертификата полностью погашена!'"))
		.Свойство("[3].Текст")
			.Содержит(НСтр("ru = 'В строке 2 подарочный сертификат не был активирован ранее (или уже полностью использован)!'"))
		.Свойство("[4].Текст")
			.Содержит(НСтр("ru = 'В строке 2 истек срок действия подарочного сертификата!'"))
		.Свойство("[5].Текст")
			.Содержит(НСтр("ru = 'В строке 2 номинальная стоимость подарочного сертификата полностью погашена!'"))
		;

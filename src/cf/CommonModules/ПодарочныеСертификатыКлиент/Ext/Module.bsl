		...
		Для Каждого ПодарочныйСертификат Из РезультатЗакрытия Цикл
			...
			Если СтрокиТабличнойЧасти.Количество() = 0 Тогда
				...
				ИначеЕсли ЭтоРеализацияТоваров Тогда
					...
					Форма.Элементы.ОплатаПодарочнымиСертификатамиСуммаОплаты.ТекстПодвала = Формат(ОбъектФормы.ОплатаПодарочнымиСертификатами.Итог("СуммаОплаты"), "ЧДЦ=2; ЧРГ=,") + " " + ОбъектФормы.Валюта;

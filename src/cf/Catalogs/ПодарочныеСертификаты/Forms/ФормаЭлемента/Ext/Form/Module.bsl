...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Запрос.Текст = 
		...
		|	ЕСТЬNULL(ВТ_СрокДействия.ДействуетДо, ДАТАВРЕМЯ(1,1,1)) КАК ДействуетДо,
		...
		|	ВТ_СрокДействия КАК ВТ_СрокДействия,

...
Функция СгенерироватьПодарочныеСертификатыНаСервере()
	...
	Попытка
		...
		ЭлементБлокировки = БлокировкаДанных.Добавить("Справочник.ПодарочныеСертификаты");
		ЭлементБлокировки.Режим = РежимБлокировкиДанных.Разделяемый;
		ЭлементБлокировки.УстановитьЗначение("Владелец", Объект.ВидПодарочныхСертификатов);

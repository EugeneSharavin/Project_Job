...
Функция СгенерироватьПодарочныеСертификаты() Экспорт
	...
	Попытка				
		...
		НовыйДокумент.Сумма = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВидПодарочныхСертификатов, "НоминальнаяСтоимость") * НовыйДокумент.ПодарочныеСертификаты.Количество();
